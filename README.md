...
<img src="Figs/Eq1.png" width="30%" style="display: block; margin: auto;" />

Where *Slope* controls the slope (is positive for increasing sections
and negative for decreasing sections), and, *Mid* controls the midpoint
of the logistic functions, and is computed as:

<img src="Figs/Eq2.png" width="26%" style="display: block; margin: auto;" />
